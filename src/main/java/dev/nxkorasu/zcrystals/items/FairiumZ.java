...
import static dev.nxkorasu.zcrystals.util.ZCrystals.FAIRIUM_Z;
...
public class FairiumZ extends SimplePolymerItem {
    ...
    private void RemoveItem(ItemUsageContext itemUsageContext){
        ...
        if(!offHand.getItem().equals(FAIRIUM_Z)){
    ...
    public ActionResult useOnBlock(ItemUsageContext itemUsageContext) {
        ...
        ItemStack offHand = Objects.requireNonNull(itemUsageContext.getPlayer()).getOffHandStack();
        if(!offHand.getItem().equals(FAIRIUM_Z) || !heldStack.getItem().equals(FAIRIUM_Z)){
